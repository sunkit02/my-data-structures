...
import datastructures.stacks.MyArrayStack;
...
class MyArrayStackTest {
    ...
    private MyArrayStack<Integer> underTest;

    @BeforeEach
    void setUp() {
        underTest = new MyArrayStack<>();
    }
    ...
    void canInitializeMyStackWithCustomInitialCapacity(int initialCapacity) {
        // given
        underTest = new MyArrayStack<>(initialCapacity);
    ...
    void canThrowExceptionWhenInitialCapacityLessThanOne(int initialCapacity) {
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> underTest = new MyArrayStack<>(initialCapacity))
    ...
    void canThrowExceptionWhenMinCapacityGreaterThanInitialCapacity(
        ...
        assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(() -> underTest =
                        new MyArrayStack<>(initialCapacity,minCapacity))
